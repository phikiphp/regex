...
it('can parse a simple character pattern', function () {
    ...
    expect($pattern->alternations)->toHaveCount(1);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(LiteralCharacter::class);
});
...
it('can parse a simple period pattern', function () {
    ...
    expect($pattern->alternations)->toHaveCount(1);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(Period::class);
});
...
it('can parse a simple group pattern', function () {
    ...
    expect($pattern->alternations)->toHaveCount(1);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(Group::class);
    expect($pattern->alternations[0]->elements[0]->atom->pattern->alternations[0]->elements)->toHaveCount(3);

    $elements = $pattern->alternations[0]->elements[0]->atom->pattern->alternations[0]->elements;
...
it('can parse a simple character class', function () {
    ...
    expect($pattern->alternations)->toHaveCount(1);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(CharacterClass::class);
    expect($pattern->alternations[0]->elements[0]->atom->members)->toHaveCount(3);

    $members = $pattern->alternations[0]->elements[0]->atom->members;
...
it('can parse a simple negated character class', function () {
    ...
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(CharacterClass::class);
    expect($pattern->alternations[0]->elements[0]->atom->members)->toHaveCount(3);
    expect($pattern->alternations[0]->elements[0]->atom->negated)->toBeTrue();
...
it('can parse a character class with a simple range', function () {
    ...
    expect($pattern->alternations)->toHaveCount(1);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(CharacterClass::class);
    expect($pattern->alternations[0]->elements[0]->atom->members)->toHaveCount(1);

    $member = $pattern->alternations[0]->elements[0]->atom->members[0];
...
it('can parse a pattern with a simple N-quantifier', function () {
    ...
    expect($pattern->alternations)->toHaveCount(1);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(LiteralCharacter::class);
    expect($pattern->alternations[0]->elements[0]->quantifier)->toBeInstanceOf(Exactly::class);
    expect($pattern->alternations[0]->elements[0]->quantifier->n)->toBe(3);
});
...
it('can parse a pattern with an N-inf quantifier', function () {
    ...
    expect($pattern->alternations)->toHaveCount(1);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(LiteralCharacter::class);
    expect($pattern->alternations[0]->elements[0]->quantifier)->toBeInstanceOf(ExactlyOrMore::class);
    expect($pattern->alternations[0]->elements[0]->quantifier->n)->toBe(3);
});
...
it('can parse a pattern with an N-M quantifier', function () {
    ...
    expect($pattern->alternations)->toHaveCount(1);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(LiteralCharacter::class);
    expect($pattern->alternations[0]->elements[0]->quantifier)->toBeInstanceOf(Between::class);
    expect($pattern->alternations[0]->elements[0]->quantifier->min)->toBe(3);
    expect($pattern->alternations[0]->elements[0]->quantifier->max)->toBe(5);
});
...
it('can parse a pattern with a simple ? (zero or one) quantifier', function () {
    ...
    expect($pattern->alternations)->toHaveCount(1);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(LiteralCharacter::class);
    expect($pattern->alternations[0]->elements[0]->quantifier)->toBeInstanceOf(ZeroOrOne::class);
});
...
it('can parse a pattern with a ?? (zero or one) (lazy) quantifier', function () {
    ...
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(LiteralCharacter::class);
    expect($pattern->alternations[0]->elements[0]->quantifier)->toBeInstanceOf(ZeroOrOne::class);
    expect($pattern->alternations[0]->elements[0]->quantifier->greedy)->toBeFalse();
    expect($pattern->alternations[0]->elements[0]->quantifier->lazy)->toBeTrue();
});
...
it('can parse a pattern with a ?+ (zero or one) (possessive) quantifier', function () {
    ...
    expect($pattern->alternations[0]->elements[0]->quantifier)->toBeInstanceOf(ZeroOrOne::class);
    expect($pattern->alternations[0]->elements[0]->quantifier->greedy)->toBeFalse();
    expect($pattern->alternations[0]->elements[0]->quantifier->possessive)->toBeTrue();
});
...
it('can parse a pattern with simple * (zero or more) quantifier', function () {
    ...
    expect($pattern->alternations)->toHaveCount(1);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(LiteralCharacter::class);
    expect($pattern->alternations[0]->elements[0]->quantifier)->toBeInstanceOf(ZeroOrMore::class);
});
...
it('can parse a pattern with simple + (one or more) quantifier', function () {
    ...
    expect($pattern->alternations)->toHaveCount(1);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(LiteralCharacter::class);
    expect($pattern->alternations[0]->elements[0]->quantifier)->toBeInstanceOf(OneOrMore::class);
});
...
it('can parse a pattern with an alternation', function () {
    ...
    expect($pattern->alternations)->toHaveCount(2);
    expect($pattern->alternations[0]->elements[0]->atom)->toBeInstanceOf(LiteralCharacter::class);
    expect($pattern->alternations[1]->elements[0]->atom)->toBeInstanceOf(LiteralCharacter::class);
});
